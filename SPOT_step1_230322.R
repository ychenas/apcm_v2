...
#  ymax <- 212
  ...
  for (yr in str_yr:end_yr){ #doesn't iterate yr 2018 because when iterating 2017, 2018 will be counted in
    ...
    for (aoi in 1:length(allaoi)){
      ...
      allpoints$class[allpoints$class==3 & allpoints$population<=2000] <- 3
      allpoints$class[allpoints$class==3 & allpoints$population>2000 & allpoints$canopy<=1] <- 3
      allpoints$class[allpoints$class==3 & allpoints$population>2000 & allpoints$canopy>1] <- 2
      ...
      if (yr==2017){
        writeRaster(outputraster,paste(image_path,"2017and2018_",allaoi[aoi],"_tree17.tif",sep=""),overwrite=TRUE)

        png(paste(image_path,"2017and2018_",allaoi[aoi],"_tree17.png",sep=""),
             width = 1080, height = 1080, units = "px")
      }else{
        writeRaster(outputraster,paste(image_path,yr,"_",allaoi[aoi],"_tree17.tif",sep=""),overwrite=TRUE)
       
        png(paste(image_path,yr,"_",allaoi[aoi],"_tree17.png",sep=""),
            width = 1080, height = 1080, units = "px")
      }
      plot(outputraster,
           col=colors)
